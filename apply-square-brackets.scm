...
;; if you want it as a module:
;;(define-module (apply-square-brackets)

;;  #:export ($bracket-apply$ slice))
...
;; 	    (if (equal? slice index) ;; T[/] 
;; 		(vector-copy container-eval) ;; return a copy of the vector
;; 		;; index is not / , should be a number
...
;; 		  (else (function-array-n-dim-ref container-eval (list index3-or-keyword-or-step-eval index2-or-keyword-eval index1-or-keyword-eval))))) ;; was reverse list ...
...
;; 		  (else (error "$bracket-apply$ : in string case, provided too much arguments:" index1-or-keyword-eval index2-or-keyword-eval index3-or-keyword-or-step-eval))))
...
;;       {index1-or-keyword-eval <+ index1-or-keyword}
;;       {index2-or-keyword-eval <+ index2-or-keyword}
;;       {index3-or-keyword-eval <+ index3-or-keyword}
;;       {index4-or-keyword-or-step-eval <+ index4-or-keyword-or-step}
...
;;       {index2-or-keyword-eval <+ index2-or-keyword}
;;       {index3-eval <+ index3}
;;       {index4-or-keyword-eval <+ index4-or-keyword}
;;       {index5-or-step-eval <+ index5-or-step}
...
;;       ;; to avoid compute it twice or many
;;       {array-eval <+ array}
;;       ;; note: we can not pre-evaluate ellipsis !
